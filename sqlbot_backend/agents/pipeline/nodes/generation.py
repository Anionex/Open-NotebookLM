...
from sqlbot_backend.agents.pipeline.state import AgentState, OutputMode
...
def agent_node(state: AgentState, config: PipelineConfig) -> dict:
    ...
    """
    from sqlbot_backend.agents.prompts.builder import build_system_prompt
    from sqlbot_backend.agents.prompts.correction import build_correction_prompt
...
def _try_multi_candidate(state: AgentState, config: PipelineConfig, rag_context: dict):
    ...
    """
    try:
        from sqlbot_backend.agents.multi_candidate_generator import multi_candidate_generator
