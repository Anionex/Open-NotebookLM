...
def retrieve_knowledge_node(state: AgentState, config: PipelineConfig) -> dict:
    ...
    """
    import asyncio
    from sqlbot_backend.modules.rag.terminology import terminology_service
    from sqlbot_backend.modules.rag.few_shot import few_shot_service
    from sqlbot_backend.modules.rag.column_ranker import column_ranking_service
...
def _match_sql_patterns(question: str) -> List[str]:
    ...
    try:
        from sqlbot_backend.modules.rag.sql_pattern_templates import sql_pattern_service
