...
def spec_verification_node(state: AgentState, config: PipelineConfig) -> Dict[str, Any]:
    ...
    try:
        from sqlbot_backend.modules.ega.spec_verifier import extract_deliverable_spec, verify_result
        ...
        if verification.get("ok"):
            ...
            try:
                ...
                if ds_ids and isinstance(ega_context, dict) and ega_context.get("alignment_graph"):
                    ...
                    from sqlbot_backend.modules.ega.orchestrator import write_success_memory
