...
class LLMFactory:
    ...
    def _create_openai(config: LLMConfig):
        """创建OpenAI ChatModel"""
        from sqlbot_backend.core.openai_compat_chat_model import OpenAICompatChatModel
    ...
    def _create_azure(config: LLMConfig):
        ...
        from sqlbot_backend.core.openai_compat_chat_model import AzureOpenAICompatChatModel
