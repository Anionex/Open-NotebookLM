...
**在线体验 Demo：** https://opennotebook.nas.cpolar.cn/
...
- **2026.03.25** — 补充表格处理与智能取数相关功能：可基于自然语言需求对 CSV / 表格数据进行查询、筛选、提取和导出；新增笔记保存到后端产出列表并支持二次编辑
...
<div align="center">
<img src="static/readme/headlesheet.png" alt="智能取数与表格处理" width="90%"/>
<p><em>智能取数与表格处理 — 根据自然语言需求查询、筛选并导出表格数据</em></p>
</div>
...
| 📈 **智能取数 / 表格处理** | 面向 CSV / 表格数据的自然语言分析与导出，可根据业务需求提取字段、筛选条件并返回结果表 |
